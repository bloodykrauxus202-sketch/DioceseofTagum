  ...
  return (
    <View className="flex-1 bg-gray-50">
      ...
      <View className="flex-1 lg:flex-row lg:max-w-7xl lg:mx-auto w-full">
        {/* Parish Image Placeholder - 100% width on Mobile, 40% Width on Desktop */}
        <View
          ...
          <View className="px-4 py-6">
            ...
            <Animated.View entering={FadeInDown.delay(400)}>
              <Pressable
                ...
                className="bg-white rounded-2xl p-5 mb-4 active:bg-gray-50 border-b border-gray-100"
              >
                <View className="flex-row items-center justify-between">
                  <View className="flex-row flex-1">
