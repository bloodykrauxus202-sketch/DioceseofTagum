...
export default function CBCPDocumentsScreen() {
    ...
    <View className="flex-1 bg-white">
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ padding: 24, alignItems: 'center' }}>
        ...
        >
          ...
          >
            <FileText size={40} color="#1D4ED8" strokeWidth={1.5} />
          </View>
          ...
          <Text style={{ fontSize: 19, color: '#6B7280', textAlign: 'center', lineHeight: 22 }}>
            Catholic Bishops Conference of the Philippines documents will be listed here.
          </Text>
        </View>
      </ScrollView>
