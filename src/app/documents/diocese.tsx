...
export default function DioceseDocumentsScreen() {
    ...
    <View className="flex-1 bg-white">
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ padding: 24, alignItems: 'center' }}>
        ...
        >
          ...
          >
            <FileText size={40} color="#1e3a5f" strokeWidth={1.5} />
          </View>
          <Text style={{ fontSize: 24, fontWeight: '700', color: '#111827', textAlign: 'center' }}>
            Diocese of Tagum Pastoral & Circular Letters
          </Text>
          <Text style={{ fontSize: 19, color: '#6B7280', textAlign: 'center', lineHeight: 22 }}>
            Pastoral letters and circulars from the Diocese of Tagum will be listed here.
          </Text>
        </View>
      </ScrollView>
